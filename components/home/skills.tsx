...
const SkillsSection = () => {
  ...
  const renderSectionTitle = (): React.ReactNode => (
    <div className="flex flex-col">
      <p className="section-title-sm seq"></p>
      <h1 className="section-heading seq mt-2">Our Expertise</h1>
      <h2 className="text-2xl md:max-w-2xl w-full seq mt-2">
      Our members possess outstanding knowledge of modern technologies, and they continually strive to stay at the forefront of advancements in their respective fields. With a deep understanding of the latest tools, trends, and innovations, they bring invaluable expertise to our organization. Their expertise extends to the following technologies:{" "}
      </h2>
    </div>
  );
